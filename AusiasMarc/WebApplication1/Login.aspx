...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <asp:TextBox ID="TextBox1" runat="server" MaxLength="8" TextMode="Number"></asp:TextBox>
        <asp:TextBox ID="TextBox2" runat="server" TextMode="Password" MaxLength="4"></asp:TextBox>
    ...
    <div>
        <asp:TextBox ID="TextBox3" runat="server" MaxLength="8" TextMode="Number"></asp:TextBox>
        <asp:TextBox ID="TextBox4" runat="server" TextMode="Password" MaxLength="4"></asp:TextBox>
    </div> 
    <div>
